...
{
    public partial class UserControllScheduleTest : UserControl
    {
        ...
        public void LoadInfo(int LocalDrivingLicenseApplicationID, int AppointmentID = -1)
        {
            ...
            {
                lblRetakeAppFees.Enabled = false;
        ...
        public UserControllScheduleTest()
        {
            InitializeComponent();
        }
        ...
        private void UserControllScheduleTest_Load(object sender, EventArgs e)
        {
